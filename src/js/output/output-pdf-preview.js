 ...
 * 100%を「現在の表示領域へA4全体が収まる倍率」とし、そこを基準に拡大縮小する。
 */
...
export class OutputPdfPreview{
  ...
  async render(){
    ...
    const cssScale=fitScale*(this.zoom/100);
